function classseupdate(row)
{
    ...
    $('#dd').dialog({
        ...
        buttons:[{ //为对话框添加底部按钮
            ...
            handler:function(){
                $('#ff').form('submit', {
                    url:"../classse/updateByPrimaryKeySelective",
                    onSubmit: function(){
                        //在这里编写表单字段验证
                    },
                        ...
                        $.messager.confirm('确认', '您确认想要删除记录吗？', function (r) {
                            ...
                            if (r) { //若确认要删除，则采用异步方式把要删除的数据行对应的id串传送给后台进行处理
                                ...
                                $.ajax({
                                    ...
                                    url: "../classse/deleteByList",//后台处理程序
